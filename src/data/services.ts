...
export const services: ServiceData[] = [
  {
    ...
    metaDescription: "Restorative commercial carpet cleaning across Philadelphia and the surrounding counties. Hot water extraction, traffic lane and stain work. (215) 550-1414.",
  ...
  },
  {
    ...
    metaTitle: "Carpet Maintenance Programs Philadelphia | PHL Clean",
    metaDescription: "Scheduled commercial carpet maintenance across Philadelphia and the surrounding counties. Interim encapsulation plus restorative extraction. (215) 550-1414.",
    ...
    whyChoose: [
      ...
      { title: "Your Building Has a File", description: "Surfaces, methods, the areas that gave trouble last time, access and alarm notes — all written down. Whoever is scheduled works from that record instead of rediscovering your floor." },
    ],
    faqs: [
  ...
  },
  {
    ...
    metaDescription: "Commercial tile and grout cleaning across Philadelphia and the surrounding counties. Pressure extraction that empties the joint instead of filling it.",
  ...
  },
  {
    ...
    metaDescription: "Commercial grout color sealing, cut-out and re-grout across Philadelphia and the surrounding counties. We fix failed joints instead of sealing over them.",
  ...
  },
  {
    ...
    metaTitle: "Hard Surface & VCT Floor Care Philadelphia | PHL Clean",
    metaDescription: "VCT strip and finish, burnishing, concrete and terrazzo care across Philadelphia and the surrounding counties. Slip resistance measured, not assumed.",
