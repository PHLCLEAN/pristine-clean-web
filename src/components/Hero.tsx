  ...
  return (
    <section className="relative bg-white overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="bg-[url('https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.3')] bg-cover bg-center h-full w-full opacity-20"></div>
      ...
      <div className="container-custom relative z-10 py-20 md:py-32">
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Providing exceptional commercial cleaning, carpet cleaning, and deep cleaning services that exceed expectations and create healthier environments.
          </p>
